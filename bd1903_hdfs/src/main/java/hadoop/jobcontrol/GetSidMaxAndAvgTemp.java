 ...
 * @program: bd1903_hdfs
 * @package: hadoop.jobcontrol
 * @filename: GetSidMaxAndAvgTemp.java
 * @create: 2019/10/11 19:53
 * @author: 29314
 * @description: .获取每个气象站最高和平均温度
 **/

public class GetSidMaxAndAvgTemp extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        Job job = Job.getInstance(conf, "获取每个气象站最高和平均温度");
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new GetSidMaxAndAvgTemp(),args));
    }
}
