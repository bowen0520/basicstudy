...
public class TotalSort3 extends Configured implements Tool {
    static class MyMapper extends Mapper<LongWritable, Text,LongWritable, DoubleWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            this.k2.set(Long.parseLong(ss[0]));
            this.v2.set(Double.parseDouble(df.format(Double.parseDouble(ss[2]))));
            context.write(this.k2,this.v2);
        }
    }

    static class MyReducer extends Reducer<LongWritable,DoubleWritable,LongWritable,DoubleWritable>{
    ...
    public int run(String[] strings) throws Exception {
        ...
        Job job = Job.getInstance(conf, "全局排序3");
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new TotalSort3(),args));
    }
}
