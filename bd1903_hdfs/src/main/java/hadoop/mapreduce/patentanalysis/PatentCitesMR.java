 ...
 * @author: 29314
 * @description: .专利数据分析（mapperreduce）分析专利引用了哪些专利
 **/

public class PatentCitesMR extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new PatentCitesMR(),args));
    }
